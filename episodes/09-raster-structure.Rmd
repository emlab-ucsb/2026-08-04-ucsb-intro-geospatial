...
ggplot() +
  geom_raster(data = RGB_2m_df_nd, 
              mapping = aes(x = x, y = y, fill = hex)) +
  scale_fill_identity() +
...
ggplot() +
  geom_raster(data = RGB_2m_nas, 
              mapping = aes(x = x, y = y, fill = HARV_RGB_Ortho_3)) +
